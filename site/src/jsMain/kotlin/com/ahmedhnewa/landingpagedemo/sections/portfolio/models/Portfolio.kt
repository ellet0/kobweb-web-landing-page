package com.ahmedhnewa.landingpagedemo.sections.portfolio.models
...
enum class Portfolio(
    ...
    One(
        image = Res.Assets.Images.FRESH_PLATFORM,
    ...
    Two(
        image = Res.Assets.Images.DR_RIADH_LAB,
        title = "Dr.Riadh lab",
    ...
    Three(
        image = Res.Assets.Images.ALRAYADA_PROJECT,
    ...
    Four(
        image = Res.Assets.Images.WALLPAPER_ENGINE,
    ...
    Five(
        image = Res.Assets.Images.AHMED_HNEWA_SOCIAL_MEDIA,
